...
Version `0.6.1` supports Python 3.11+ and has no runtime package dependencies.
...
shows the active Enter action, next Tab action, and any notice. Enter applies that
